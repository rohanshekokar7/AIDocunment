...
A production-ready AI-powered Document Classification System built with **FastAPI** and **Qwen2.5-VL** (Vision-Language Model).
...
- **Multimodal**: Analyzes PDFs and Images directly using VLM (no fragile OCR pipelines).
...
│   ├── prompts/
│   │   └── classification_prompt.py # VLM Prompt Engineering
│   ├── services/
│   │   ├── model_service.py  # Qwen2.5-VL lazy loading and inference
...
- **Model Quantization**: Use AWQ or GPTQ versions of Qwen2.5-VL to drastically reduce VRAM usage.
